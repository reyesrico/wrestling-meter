  ...
  return (
    ...
    >
      <div className="wrestler-card__image">
        <img src={wrestler.imageUrl} alt={wrestler.name} loading="lazy" />
        <span className="company-tag" style={{ '--company': company.accent } as CSSProperties}>
          {company.shortName}
        </span>
      </div>
      <div className="wrestler-card__body">
